#!/usr/bin/env python3
"""Benchmark fast GPU pipeline with phase breakdown."""
...
from magicmatch_core.gpu.pipeline_fast import profile_fast_gpu_pipeline  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        "--out",
        type=Path,
        default=ROOT / "parity_out" / "bench_gpu_fast.json",
    ...
    print(f"\n=== one_shot_ms: {report.get('one_shot_ms', 0):.1f} ===")
